...
static __always_inline void						\
__lse_atomic64_##op(long i, atomic64_t *v)				\
{									\
	asm volatile(							\
	__LSE_PREAMBLE							\
	"	" #asm_op "	%[i], %[v]\n"				\
...
static __always_inline void __lse_atomic64_sub(long i, atomic64_t *v)
{
...
__lse_atomic64_fetch_##op##name(long i, atomic64_t *v)			\
{									\
	long old;							\
									\
	asm volatile(							\
...
static __always_inline long						\
__lse_atomic64_fetch_sub##name(long i, atomic64_t *v)			\
{									\
...
static __always_inline long						\
__lse_atomic64_add_return##name(long i, atomic64_t *v)			\
{									\
	return __lse_atomic64_fetch_add##name(i, v) + i;		\
}									\
									\
static __always_inline long						\
__lse_atomic64_sub_return##name(long i, atomic64_t *v)			\
{									\
...
static __always_inline void __lse_atomic64_and(long i, atomic64_t *v)
{
...
static __always_inline long						\
__lse_atomic64_fetch_and##name(long i, atomic64_t *v)			\
{									\
...
static __always_inline long __lse_atomic64_dec_if_positive(atomic64_t *v)
{
	unsigned long tmp;
