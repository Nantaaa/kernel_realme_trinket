...
#include "internals.h"
#ifdef CONFIG_PRODUCT_REALME_TRINKET //Jacky Zhuo@BSP.CHG.Function, 2019/11/29, modified for replace daily build macro
...
//Jacky Zhuo@BSP.CHG.Basic, 2019/11/29  Add for delete log in release version
		if (affinity_broken) {
